...
class TwitterTrendModelTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.twitter_country_trend = TwitterCountryTrend.objects.create(
            country=country)
        self.twitter_trend = TwitterTrend.objects.create(
            name='Trend', url=TREND_URL, tweet_volume=100, country_trend=self.twitter_country_trend)
    ...
    def test_correct_twitter_trend_model_creation_max_length_name(self):
        ...
        twitter_trend = TwitterTrend.objects.create(
            name='T'*100, url=TREND_URL, tweet_volume=100, country_trend=self.twitter_country_trend)
        self.assertEqual(twitter_trend.name, 'T'*100)

    def test_incorrect_twitter_trend_model_creation_without_name(self):

        with self.assertRaises(Exception):
            TwitterTrend.objects.create(
                name=None, url=TREND_URL, tweet_volume=100, country_trend=self.twitter_country_trend)

    def test_incorrect_twitter_trend_model_creation_blank_name(self):

        with self.assertRaises(Exception):
            twitter_trend = TwitterTrend.objects.create(
                name='', url=TREND_URL, tweet_volume=100, country_trend=self.twitter_country_trend)
    ...
    def test_incorrect_twitter_trend_model_creation_max_length_name(self):
        ...
        with self.assertRaises(Exception):
            TwitterTrend.objects.create(
                name='T'*101, url=TREND_URL, tweet_volume=100, country_trend=self.twitter_country_trend)
    ...
    def test_correct_twitter_trend_model_creation_max_length_url(self):
        ...
        twitter_trend = TwitterTrend.objects.create(
            name='Trend', url='https://' + 't'*88 + '.com', tweet_volume=100, country_trend=self.twitter_country_trend)
    ...
    def test_incorrect_twitter_trend_model_creation_without_url(self):
        ...
        with self.assertRaises(Exception):
            TwitterTrend.objects.create(
                name='Trend', url=None, tweet_volume=100, country_trend=self.twitter_country_trend)

    def test_incorrect_twitter_trend_model_creation_blank_url(self):

        with self.assertRaises(Exception):
            twitter_trend = TwitterTrend.objects.create(
                name='Trend', url='', tweet_volume=100, country_trend=self.twitter_country_trend)
            twitter_trend.full_clean()
    ...
    def test_incorrect_twitter_trend_model_creation_invalid_url(self):
        ...
        with self.assertRaises(Exception):
            twitter_trend = TwitterTrend.objects.create(
                name='Trend', url='invalid_url', tweet_volume=100, country_trend=self.twitter_country_trend)
            twitter_trend.full_clean()

    def test_incorrect_twitter_trend_model_creation_max_length_url(self):

        with self.assertRaises(Exception):
            TwitterTrend.objects.create(name='Trend', url='https://' + 't'*89 +
                                        '.com', tweet_volume=100, country_trend=self.twitter_country_trend)
    ...
    def test_correct_twitter_trend_model_creation_max_value_tweet_volume(self):
        ...
        twitter_trend = TwitterTrend.objects.create(
            name='Trend', url=TREND_URL, tweet_volume=2147483647, country_trend=self.twitter_country_trend)
    ...
    def test_incorrect_twitter_trend_model_creation_invalid_integer_tweet_volume(self):
        ...
        with self.assertRaises(Exception):
            TwitterTrend.objects.create(
                name='Trend', url=TREND_URL, tweet_volume='invalid_integer', country_trend=self.twitter_country_trend)

    def test_incorrect_twitter_trend_model_creation_max_value_tweet_volume(self):

        with self.assertRaises(Exception):
            TwitterTrend.objects.create(
                name='Trend', url=TREND_URL, tweet_volume=2147483648, country_trend=self.twitter_country_trend)
    ...
    def test_incorrect_twitter_trend_model_creation_without_country_trend(self):
        ...
        with self.assertRaises(Exception):
            TwitterTrend.objects.create(
                name='Trend', url=TREND_URL, tweet_volume=100, country_trend=None)

    def test_incorrect_twitter_trend_model_creation_invalid_country_trend(self):

        with self.assertRaises(Exception):
            TwitterTrend.objects.create(
                name='Trend', url=TREND_URL, tweet_volume=100, country_trend='invalid_country_trend')
    ...
    def test_correct_twitter_trend_model_update(self):
        ...
        self.assertEqual(self.twitter_trend.url, TREND_URL)
        self.assertEqual(self.twitter_trend.tweet_volume, 100)
        self.assertEqual(self.twitter_trend.country_trend,
                         self.twitter_country_trend)
        ...
        twitter_country_trend = TwitterCountryTrend.objects.create(
            country=country)
...
class TwitterCountryTrendModelTestCase(TestCase):
    ...
    def test_correct_twitter_country_trend_model_creation(self):
        ...
        self.assertTrue(isinstance(
            self.twitter_country_trend, TwitterCountryTrend))
        self.assertEqual(self.twitter_country_trend.__str__(),
                         self.country.name)
    ...
    def test_correct_twitter_country_trend_model_update(self):
        ...
        self.twitter_country_trend.country = Country.objects.create(
            name='Argentina', native_name='Argentina', acronym='AR', flag='https://flagcdn.com/ar.svg', woeid=332471, pn='argentina')
